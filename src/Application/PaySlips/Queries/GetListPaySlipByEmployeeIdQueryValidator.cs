...
public class GetListPaySlipByEmployeeIdQueryValidator : AbstractValidator<GetListPaySlipByEmployeeIdQuery>
{
    private readonly IApplicationDbContext _context;
    public GetListPaySlipByEmployeeIdQueryValidator(IApplicationDbContext context)
    {
        _context = context;
